...
func (c *OrderClient) GetCodConfig(paramMap map[string]interface{}) (*order.GetCodResponse, error) {
	if paramMap == nil {
		paramMap = make(map[string]interface{})
	}
...
func (c *OrderClient) ConfigCod(paramMap map[string]interface{}) (*order.PostCodResponse, error) {
	if paramMap == nil {
		paramMap = make(map[string]interface{})
	}
